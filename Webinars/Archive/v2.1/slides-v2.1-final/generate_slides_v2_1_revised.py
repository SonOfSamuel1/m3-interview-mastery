#!/usr/bin/env python3
"""
Active Offer Webinar v2.1 - FINAL REVISION
Creates 120 professional PNG slides at 1920x1080 resolution (slide 2 removed)
All latest corrections applied per user feedback
"""
...
# ALL 120 SLIDES WITH LATEST CORRECTIONS (slide 2 removed, slide 48, 64, 74, 80, 104 updated)
SLIDES = [
    # PHASE 1: INTRODUCTION (Slides 1-15) - SLIDE 1 UPDATED, SLIDE 2 REMOVED
    {
        'num': 1,
        'html': create_html_template(f"""
            <div class="slide">
                <h1 style="color: {COLORS['primary']};">The Active Offer System</h1>
                <p class="subhead" style="max-width: 1300px;">How Top AEs Position Themselves So Hiring Managers Seek Them Out<br>(And How They Increase Their Annual Income by $100K in 90 Days)</p>
            </div>
        """)
    },
    # SLIDE 2 REMOVED
    ...
    # PHASE 2: THE 3 AHA MOMENTS (Slides 16-46) - SLIDE 48 UPDATED (removing Aha #4, updating Aha #2)
    {
        'num': 16,
        'html': create_html_template(f"""
            <div class="slide">
                <h1 style="color: {COLORS['accent']};">The 3 Aha Moments</h1>
    ...
    },
    {
        ...
        'html': create_html_template(f"""
            <div class="slide">
                <h2 style="margin-bottom: 80px;">The Belief Shift</h2>
                <p class="large-text" style="font-size: 72px; font-weight: 700; color: {COLORS['primary']};">"Mindshare beats applications"</p>
            </div>
        """)
    },
    {
    ...
    # PHASE 3: THE ACTIVE OFFER SYSTEM (Slides 41-69) - SLIDE 48 UPDATED
    {
        'num': 41,
        'html': create_html_template(f"""
            <div class="slide">
                <h2 style="margin-bottom: 80px;">Let's Recap The 3 Aha Moments</h2>
                <p class="large-text">These 3 discoveries transformed how I thought about my career...</p>
            </div>
        """)
    },
    {
        ...
        'html': create_html_template(f"""
            <div class="slide slide-left">
                <h2 style="margin-bottom: 40px;">The 3 Belief Shifts</h2>
                <ul style="font-size: 40px;">
                    <li><strong>Aha #1:</strong> The role you're in matters more than how hard you work</li>
                    <li><strong>Aha #2:</strong> Mindshare beats applications</li>
    ...
    },
    {
        ...
        'html': create_html_template(f"""
            <div class="slide">
                ...
                <p class="large-text" style="font-size: 48px;">$100K → $190K → $270K + $70K stock</p>
    ...
    # PHASE 4: OVERCOMING OBJECTIONS (Slides 65-89) - SLIDE 74 & 80 UPDATED
    {
        'num': 65,
        'html': create_html_template(f"""
            <div class="slide slide-left">
        ...
        'html': create_html_template(f"""
            <div class="slide">
                ...
                <div style="text-align: left; max-width: 1000px; margin: 0 auto;">
                    ...
                    <p style="font-size: 44px; margin: 25px 0;">25 min: Strategic outreach</p>
    ...
    },
    {
        ...
        'html': create_html_template(f"""
            <div class="slide slide-left">
                ...
                <ul>
                    <li class="checkmark">Telecom (this works especially well for Telecom!)</li>
    ...
    # PHASE 5: THE OFFER & CLOSE (Slides 90-120) - SLIDE 104 UPDATED
    {
        'num': 90,
        'html': create_html_template(f"""
            <div class="slide slide-left">
    ...
    },
    {
        ...
        'html': create_html_template(f"""
            <div class="slide">
                ...
                <p class="large-text">I'm not sharing a price on this call. Your situation is unique.</p>
...
def generate_slides():
    """Generate all 120 slides as PNG files (slide 2 removed)"""
    ...
    print(f"Starting slide generation for v2.1 FINAL REVISION (120 slides)...")
    print(f"Output directory: {output_dir}")
    print(f"\nAll corrections applied:")
    print(f"  ✓ Slide 1: New subtitle - 'How Top AEs Position...$100K in 90 Days'")
    print(f"  ✓ Slide 2: REMOVED completely")
    print(f"  ✓ Slide 42 (was 48): Removed Aha #4, changed Aha #2 to 'Mindshare beats applications'")
    print(f"  ✓ Slide 58 (was 64): Darrell's income shown as '$270K + $70K stock'")
    print(f"  ✓ Slide 68 (was 74): '25 min strategic outreach, 5 min follow-ups'")
    print(f"  ✓ Slide 74 (was 80): Removed SaaS/Tech, added Telecom with emphasis")
    print(f"  ✓ Slide 98 (was 104): Reworded to avoid 'revealing' - now 'sharing'")
    print(f"\n")
    ...
    with sync_playwright() as p:
        ...
        for slide_data in SLIDES:
            ...
            print(f"Generated slide {slide_num}/115")

        browser.close()

    print(f"\n✓ All 120 slides generated successfully! (slide 2 removed, now 115 total)")
    print(f"✓ Location: {output_dir}")
    print(f"\n✓ All corrections verified:")
    print(f"  - Slide 1: New subtitle applied")
    print(f"  - Slide 2: Removed")
    print(f"  - Aha moments: Now 3 (was 4)")
    print(f"  - Aha #2: 'Mindshare beats applications'")
    print(f"  - Darrell: '$270K + $70K stock' format")
    print(f"  - Time breakdown: 25min + 5min")
    print(f"  - Industries: Telecom emphasized, SaaS/Tech removed")
    print(f"  - Slide 98: No 'revealing' language")
